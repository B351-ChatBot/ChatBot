...
numSentences = len(train_x)  #number of training sentences
dictLength = len(train_x[0]) #number of training rare unique words (RUWord)

print("numSentences", numSentences, "dictLength", dictLength)

print("a single sentence = train_x[0:1]:", train_x[0:1])

##=======
train_x,train_y,test_x,test_y = create_feature_sets_and_labels('pos.txt','neg.txt')
##>>>>>>> parent of fdc435c... NN works and uses PICKLE. also wordcount and sentence count
##=======
train_x,train_y,test_x,test_y = create_feature_sets_and_labels('pos.txt','neg.txt')
##>>>>>>> parent of fdc435c... NN works and uses PICKLE. also wordcount and sentence count
##=======
...
##				print(sess.run(tf.nn.top_k(train_x[start], 100)))
				#print(sess.run(tf.nn.in_top_k(batch_y,  2, 2))) #missing 1 required positional argument: 'k'
##				print(train_x[start])
				epoch_loss += c
				i+=batch_size
